    ...
    <table class="tableForm_L" border="0" cellspacing="1" cellpadding="0">
      ...
      <tr style="margin-top: 6px;">
	     <td colspan="6" align="right">&nbsp;&nbsp;
		     <a href="#" class="easyui-linkbutton" id="tokenaccess_edit_b1_submit" onclick="tokenaccess.onSaveEdit()" data-options="iconCls:'ope-submit'" >提交</a> &nbsp;&nbsp;
		     <a href="#" class="easyui-linkbutton" id="tokenaccess_edit_b1_back" onclick="tokenaccess.back()" data-options="iconCls:'ope-previous'" >返回</a>
		 </td>
      </tr>
    </table>
  </form>
