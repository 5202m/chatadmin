  ...
  <form id="subscribeTypeEditFrom" class="yxForm" method="post">
    <table class="tableForm_L" border="0" cellspacing="1" cellpadding="0">
    	...
    	<tr>
    		...
    		<td>
    			<input type="text" name="startDateStr" id="startDate" value="${startDateStr}" onFocus="WdatePicker({minDate:'%y-%M-{%d+1}',maxDate:'#F{$dp.$D(\'endDate\')}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate easyui-validatebox" data-options="required:true" />
