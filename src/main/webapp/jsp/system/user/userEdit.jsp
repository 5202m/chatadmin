...
$(function() {
	...
	var avatarSrc=$("#saveAvatarPath").val();
  ...
  <form id="userEditForm" class="yxForm" method="post">
    <table class="tableForm_L" border="0" cellspacing="1" cellpadding="0">
        ...
        <td width="35%" colspan="3">
          <div id="user_header_tab" class="easyui-tabs" data-options="fit:true" style="height:180px;width:300px;margin-top:2px;">
			  ...
			  <div id="user_header_upload" title="本地上传" style="padding:0px;height:180px;">
			        <div>图片路径：<input type="text" id="currentAvatarPath" value="${mngUser.avatar}" style="width:350px;margin-top:5px;"/>
			        	...
			        	<!-- 表单提交时保存到数据库的字段-->
			        	<input type="hidden" name="avatar" id="saveAvatarPath" value="${mngUser.avatar}"/>
		                ...
		                <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-cut',disabled:false"  onclick="goldOfficeUtils.onCutImage('#sourceAvatarPath','#cutedAvatarPath','#saveAvatarPath')">裁剪</a> 
		            </div>
			  </div>
		 </div>
        </td>
      ...
      <tr>
        <th>简介图片</th>
        <td colspan="3">
        	<div>图片路径：<input type="text" id="introductionImgPath" value="${mngUser.introductionImg}" style="width:350px;margin-top:5px;"/>
