...
<div style="padding:5px;overflow:hidden;">
  <form id="userEditForm" class="yxForm" method="post">
    <table class="tableForm_L" border="0" cellspacing="1" cellpadding="0">
      ...
      <tr>
        <th>简介图片跳转链接</th>
        <td colspan="3"><input type="text" id="introductionImgLink" name="introductionImgLink" value="${mngUser.introductionImgLink}" style="width:350px;margin-top:5px;"/></td>
      </tr>
      <tr>
        <th>简介图片</th>
        <td colspan="3">
      ...
      <tr>
        <th>微信二维码</th>
        <td colspan="3">
        	<div>图片路径：<input type="text" id="wechatCodeImgPath" name="wechatCodeImg" value="${mngUser.wechatCodeImg}" style="width:350px;margin-top:5px;"/>
	        	<input type="file"  id="wechatCodeImgFile" style="width:155px">
	        	<!-- 原图片路径 -->
	        	<input type="hidden" id="wechatCodeImgPathSrc" value="${mngUser.wechatCodeImg}"/>
	        	<!-- 裁剪后图片的路径 -->
	        	<input type="hidden" id="wechatCodeImgPathCut" value="${mngUser.wechatCodeImg}"/>
	        	<!-- 表单提交时保存到数据库的字段-->
