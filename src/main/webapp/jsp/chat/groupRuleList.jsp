...
<div class="easyui-layout" data-options="fit:true">
  ...
  <div id="chatGroupRule_datagrid_toolbar" style="display:none;">
    <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-add',disabled:false"  onclick="chatGroupRule.add();">新增</a>
    <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-reload',disabled:false"  onclick="chatGroupRule.refresh()"><spring:message code="common.buttons.refresh" /></a>
    <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-remove',disabled:false"  onclick="chatGroupRule.batchDel();">删除</a>
  </div> 
  
  <!-- datagrid-操作按钮 -->
  <div id="chatGroupRule_datagrid_rowOperation" style="display:none;">
	  <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-edit',disabled:false"  onclick="chatGroupRule.edit(this.id)"><spring:message code="common.buttons.edit" /></a>
	  <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-remove',disabled:false"  onclick="chatGroupRule.del(this.id)"><spring:message code="common.buttons.delete" /></a>
  </div>
