     ...
     <tr>
      ...
      <tr>
        ...
        <td width="35%" colspan="3">
        	<div id="media_div">
	        	&nbsp;媒体路径：&nbsp;<input type="text" id="currentMediaPath" disabled="disabled" style="margin-bottom: 5px;width:450px;"/>
      ...
      <tr id="mediaImageRowTr">
        ...
        <td width="35%" colspan="3">
        	<div>
	        	&nbsp;图片路径：&nbsp;<input type="text" id="currentMediaImagePath" disabled="disabled" style="margin-bottom: 5px;width:450px;"/>
