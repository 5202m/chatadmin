      ...
      <tr>
       ...
       <tr>
         ...
         <td width="35%" colspan="3">
        	<div>
	        	&nbsp;图片路径：&nbsp;<input type="text" id="currentImageFilePath" value="${member.avatar}" disabled="disabled" style="margin-bottom: 5px;width:300px;"/>
	        	...
	        	<!-- 表单提交时保存到数据库的字段-->
	        	<input type="hidden" name="avatar" id="saveImagePath" value="${member.avatar}"/>
                ...
                <a class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-cut',disabled:false"  onclick="goldOfficeUtils.onCutImage('#sourceImagePath','#cutedImagePath','member','#saveImagePath')">裁剪</a> 
	       	</div>
         </td>
       </tr>
