     ...
     <tr>
      ...
      <tr>
        ...
        <td width="35%" colspan="3">
        	<div id="media_div">
	        	&nbsp;媒体路径：&nbsp;<input type="text" id="currentMediaPath" name="mediaUrl" style="margin-bottom: 5px;width:450px;"/>
	        	...
	        	<!-- 表单提交时保存到数据库的字段-->
	        	<input type="hidden"  id="saveMediaPath" />
                ...
                <a t="cutImage" class="easyui-linkbutton" data-options="plain:true,iconCls:'ope-cut',disabled:false"  onclick="goldOfficeUtils.onCutImage('#sourceMediaPath','#cutedMediaPath','#saveMediaPath')">裁剪</a> 
            </div>
        </td>
      </tr>
      <tr>
        ...
        <td width="35%" colspan="3">
        	<input type="text" name="linkUrl" style="width: 800px;" class="easyui-validatebox" data-options="required:true,missingMessage:'请输入链接URL'"/>
        </td>
      </tr>
      <tr id="mediaImageRowTr">
        ...
        <td width="35%" colspan="3">
        	<div>
	        	&nbsp;图片路径：&nbsp;<input type="text" id="currentMediaImagePath" name="mediaImgUrl" style="margin-bottom: 5px;width:450px;"/>
	        	...
	        	<!-- 表单提交时保存到数据库的字段-->
	        	<input type="hidden"  id="saveMediaImagePath" />
